...
namespace cryptonote
{
  ...
  public:
    ...
    blockchain_storage(tx_memory_pool& tx_pool):m_tx_pool(tx_pool), m_current_block_cumul_sz_limit(0), m_is_in_checkpoint_zone(false), m_is_blockchain_storing(false), m_pcatchup_thread(NULL), m_stop_catchup(false)
    {};
