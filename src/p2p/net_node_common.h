...
namespace nodetool
{
  ...
  {
    virtual bool relay_notify_to_all(int command, const std::string& data_buff, const epee::net_utils::connection_context_base& context, bool only_if_state, typename t_connection_context::state s)=0;
  ...
  {
    virtual bool relay_notify_to_all(int command, const std::string& data_buff, const epee::net_utils::connection_context_base& context, bool only_if_staet, typename t_connection_context::state s)
    {
      return false;
    }
