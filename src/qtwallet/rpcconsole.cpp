...
{
    emit reply(RPCConsole::CMD_ERROR, QString("The RPC console is not implemented yet"));
    return;
    /*
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
        ...
        setNumBlocks(model->getDaemonProcessedHeight(), model->getWalletProcessedHeight(),
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Pebblecoin RPC console.") + "<br>" +
...
void RPCConsole::setNumBlocks(int daemonCount, int walletCount, int countOfPeers)
{
    ui->numberOfBlocks->setText(QString::number(daemonCount));
    ...
    if(clientModel)
        ui->lastBlockTime->setText(clientModel->getLastDaemonBlockDate().toString());
}
