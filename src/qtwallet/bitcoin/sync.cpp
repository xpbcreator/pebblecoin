...
struct CLockLocation
{
    ...
    {
        return mutexName+"  "+sourceFile+":"+boost::lexical_cast<std::string>(sourceLine);
    }
...
static void push_lock(void* c, const CLockLocation& locklocation, bool fTry)
{
    ...
    if (!fTry) {
        BOOST_FOREACH(const auto& i, (*lockstack)) {
            if (i.first == c) break;
