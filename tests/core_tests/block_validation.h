...
public:
  ...
  bool check_block_purged(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
  {
...
struct gen_block_accepted_base : public test_chain_unit_base
{
  ...
  bool check_block_accepted(core_t& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
  {
