...
bool gen_simple_chain_split_1::generate(std::vector<test_event_entry> &events) const
{
  ...
  */
  ...
  MAKE_TX(events, tx_0, first_miner_account, alice, 10, blk_23r);                    //  N1+1
  MAKE_TX(events, tx_1, first_miner_account, alice, 20, blk_23r);                    //  N1+2
  MAKE_TX(events, tx_2, first_miner_account, alice, 30, blk_23r);                    //  N1+3
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_1(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched_back(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_1(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
bool gen_simple_chain_split_1::check_split_switched_back_2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
/*
bool gen_simple_chain_split_1::check_orphaned_chain_1(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_alternative(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_main(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_38(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_39(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_40(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_41(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
