...
public: 
  ...
  bool check_split_not_switched_back(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events);
  bool check_split_switched_back_1(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events);
  bool check_split_switched_back_2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events);
  bool check_mempool_1(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events);
  bool check_mempool_2(core_t& c, size_t ev_index, const std::vector<test_event_entry> &events);
