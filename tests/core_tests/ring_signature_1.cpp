...
namespace
{
  ...
  const uint64_t rnd_11 = 114;
  const uint64_t rnd_20 = 219;
  const uint64_t rnd_29 = 665;
}
...
bool gen_ring_signature_1::check_balances_1(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_1::check_balances_2(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  CHECK_EQ(129 + 2 * rnd_11 + rnd_20 + 3 * rnd_29 - TESTS_DEFAULT_FEE, get_balance(m_alice_account, chain, mtx));
...
bool gen_ring_signature_2::generate(std::vector<test_event_entry>& events) const
{
  ...
  MAKE_NEXT_BLOCK(events, blk_1pre, blk_0, miner_account);                                                 //  3
  MAKE_NEXT_BLOCK(events, blk_1, blk_1pre, miner_account);                                                 //  4
...
bool gen_ring_signature_2::check_balances_1(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_2::check_balances_2(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  CHECK_EQ(12 - TESTS_DEFAULT_FEE, get_balance(m_alice_account, chain, mtx));
...
bool gen_ring_signature_big::check_balances_1(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
...
bool gen_ring_signature_big::check_balances_2(core_t& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
